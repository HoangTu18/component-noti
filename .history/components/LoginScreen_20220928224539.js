...
function LoginScreen(props) {
  const yourLoginFunction = async () => {
    console.log("click tao");
    ...
    await registerIndieID(4066, 4066, "mIFjJ9VQl0tNBXc5IAO65x");
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Click me " onPress={yourLoginFunction} />
    </View>
  );
}
